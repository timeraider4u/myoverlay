...
IUSE="aac aften a52 alsa amr debug dts fontconfig fribidi jack lame libsamplerate cpu_flags_x86_mmx opengl oss pulseaudio qt5 vorbis truetype twolame xv xvid x264 vdpau vpx"
KEYWORDS="~amd64 ~x86"
